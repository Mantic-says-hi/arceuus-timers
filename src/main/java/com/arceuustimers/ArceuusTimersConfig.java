...
public interface ArceuusTimersConfig extends Config {
	...
	@ConfigItem(
			...
			description = "While on, a preview icon shows on your character and you can drag it with the left mouse button to position it. Right-click the icon to reset the offset to 0,0. Turn off when done.",
			position = 38
	)
	...
	@ConfigItem(
			...
			name = "Y-Offset",
			description = "Vertical offset in pixels from the anchor point. Negative moves the icon up, positive down.<br>"
					+ "Tip: turn on 'Reposition Mode' to drag the on-player icon into place instead.",
			position = 36
	)
	...
	@ConfigItem(
			...
			name = "X-Offset",
			description = "Horizontal offset in pixels from the anchor point. Negative moves the icon left, positive right.<br>"
					+ "Tip: turn on 'Reposition Mode' to drag the on-player icon into place instead.",
			position = 37
	)
